...
#retrieve capacity of room 201 and store it in a variable
room_201 = hash_one[:data][:rooms][0][:capacity]
puts room_201

#find all the events taking place in room 201 and iterate through them if the number of planned atendees will fit
